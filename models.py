...
from keras.layers import Input,BatchNormalization,Conv2D,Activation,Lambda,Subtract,Conv2DTranspose, PReLU
...
def SRCNN_train(train_data ,train_label, val_data , val_label , channel_model , num_pilots , SNR ):
    ...
    srcnn_model.fit(train_data, train_label, batch_size=128,epochs= 300 , verbose=0,
                    callbacks=callbacks_list, validation_data=(val_data, val_label),shuffle=True)
